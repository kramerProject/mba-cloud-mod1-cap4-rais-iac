...
@dag(default_args=default_args, schedule_interval=None, catchup=False, tags=["emr", "aws", "enem"], description="Pipeline for rais processing")
def pipeline_rais():
    """
    ...
    def emr_process_rais_data():
        cluster_id = client.run_job_flow(
            Name='EMR-Kramer-IGTI-delta-airflow',
